...
<div class="app">
  <aside class="sidebar">
    ...
    <nav>{{range .Workspaces}}<a class="workspace-link" href="{{workspaceHref .ID}}"><span class="dot"></span><span class="workspace-link-text"><span class="workspace-link-id">{{.ID}}</span><span class="workspace-link-title">{{.Title}}</span></span></a>{{end}}</nav>
  </aside>
  <main>
...
<div class="app">
  <aside class="sidebar">
    <div class="brand"><div class="brand-mark">kra</div><div><strong>Workspace Boards</strong><span class="small">open workspaces only</span></div></div>
    <a class="side-label-link" href="/workspaces/">Open workspaces</a>
    <nav>{{range .Workspaces}}<a class="workspace-link {{if eq .ID $.Workspace.ID}}active{{end}}" href="{{workspaceHref .ID}}"><span class="dot"></span><span class="workspace-link-text"><span class="workspace-link-id">{{.ID}}</span><span class="workspace-link-title">{{.Title}}</span></span></a>{{end}}</nav>
  </aside>
  <main>
