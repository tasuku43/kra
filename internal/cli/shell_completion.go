...
var kraCompletionPathFlags = map[string][]string{
	...
	"ws task view":            {"--id", "--current", "--cmux-current", "--select", "--all", "--watch", "--todo-only", "--include-done", "--refresh", "--no-color", "--help", "-h"},
	"ws task tui":             {"--id", "--current", "--cmux-current", "--select", "--all", "--todo-only", "--include-done", "--refresh", "--no-color", "--help", "-h"},
