...
var kraCompletionSubcommands = map[string][]string{
	...
	"task":     {"tui", "view", "list", "ls", "add", "status", "help"},
...
var kraCompletionCommandFlags = map[string][]string{
	...
	"serve":   {"--addr", "--help", "-h"},
	"task":    {"--todo-only", "--include-done", "--no-color", "--help", "-h"},
...
var kraCompletionPathFlags = map[string][]string{
	...
	"task":                    {"--todo-only", "--include-done", "--no-color", "--help", "-h"},
	"task tui":                {"--todo-only", "--include-done", "--no-color", "--help", "-h"},
	"task view":               {"--todo-only", "--include-done", "--no-color", "--help", "-h"},
	"task list":               {"--format", "--help", "-h"},
	"task ls":                 {"--format", "--help", "-h"},
	"task add":                {"--title", "--description", "--format", "--help", "-h"},
	"task status":             {"--todo-only", "--include-done", "--no-color", "--format", "--help", "-h"},
