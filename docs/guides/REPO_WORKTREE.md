...
- `repo add` contract: `docs/spec/commands/repo/add.md`
- `ws add-repo` contract: `docs/spec/commands/ws/add-repo.md`
- `ws remove-repo` contract: `docs/spec/commands/ws/remove-repo.md`
