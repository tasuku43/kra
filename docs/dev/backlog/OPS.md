...
- [x] OPS-002: Workspace multi-select action (`ws select --multi`)
  ...
  - Specs:
    ...
    - `docs/dev/spec/commands/ws/select.md`
...
- [x] OPS-003: Machine-readable output parity across major commands
  ...
  - Specs:
    - `docs/dev/spec/concepts/output-contract.md`
...
- [x] OPS-005: Workspace lifecycle dry-run JSON parity (`close`/`reopen`/`purge`)
  ...
  - Specs:
    ...
    - `docs/dev/spec/commands/ws/dry-run.md`
    - `docs/dev/spec/concepts/output-contract.md`
  - Depends: OPS-003
  - Parallel: yes
...
- [x] OPS-006: Workspace lock/unlock safety gate (`ws lock` / `ws unlock`)
  ...
  - Specs:
    - `docs/dev/spec/commands/ws/lock.md`
    - `docs/dev/spec/commands/ws/close.md`
    - `docs/dev/spec/commands/ws/purge.md`
    - `docs/dev/spec/concepts/workspace-lifecycle.md`
  - Depends: none
...
- [x] OPS-007: Branch naming policy templates for `ws add-repo`
  ...
  - Specs:
    - `docs/dev/spec/concepts/branch-naming-policy.md`
...
- [x] OPS-011: Workspace insight capture (important-only, conversational proposal)
  ...
  - Specs:
    - `docs/dev/spec/concepts/worklog-insight.md`
    - `docs/dev/spec/commands/ws/insight.md`
  - Depends: none
  - Serial: yes
...
- [x] OPS-015: Read-path purity for workspace inspection commands
...
- [x] OPS-016: Recoverable `ws close` lifecycle journal + doctor-assisted resume
...
- [x] OPS-017: Root runtime-state ignore reconciliation and hygiene drift
