...
- [x] UX-WS-002: `kra ws close` selector-mode + bulk safety gate
...
- [x] UX-WS-003: `kra ws open` command (start-work flow)
  ...
  - Specs:
    - `docs/dev/spec/commands/ws/open.md`
    - `docs/dev/spec/commands/ws/selector.md`
  - Depends: UX-WS-001, MVP-020
  - Parallel: yes (with UX-WS-002)

- [x] UX-WS-004: `kra ws reopen` selector-mode
...
- [x] UX-WS-005: `kra ws purge` selector-mode
...
- [x] UX-WS-006: `kra ws list` selector-parity output
...
- [x] UX-WS-022: Context-aware `ws` launcher behavior
  - What: make `kra ws` context-aware:
...
- [x] UX-WS-025: Shell action protocol (`action file`) for post-exec parent-shell effects
  ...
  - Specs:
    - `docs/dev/spec/commands/shell/init.md`
    - `docs/dev/spec/commands/ws/open.md`
  - Depends: UX-WS-022
  - Parallel: yes
...
- [x] UX-WS-029: `ws --act remove-repo` (workspace binding + worktree removal)
  ...
  - Specs:
    - `docs/dev/spec/commands/ws/remove-repo.md`
    - `docs/dev/spec/commands/ws/select.md`
    - `docs/dev/spec/commands/ws/selector.md`
    - `docs/dev/spec/commands/ws/add-repo.md`
